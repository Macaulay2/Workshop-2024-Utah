...
-- gvInvariantsNew below will be named this eventually.
gvInvariants = method(Options => {
    ...
    Precision => 150,
    -- TODO: remove the next 3 options
    FilePrefix => "foo",
...
gvInvariantsNew = method(Options => {
    Mori => null, -- null means: compute rays of the Mori cone of V (in ZZ^(h11))
    Heft => null, -- null means: compute it
...
gvInvariantsNew(NormalToricVariety, List) := HashTable => opts -> (V, basisIndices) -> (
...
gvInvariantsNew CalabiYauInToric := Sequence => opts -> X -> (
